...
namespace MoviesWebApplication.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Duration,HasOscar,ProductionId")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Duration,HasOscar,ProductionId")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
